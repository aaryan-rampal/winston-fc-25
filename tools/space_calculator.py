...
SPACE_CALCULATOR_TOOLS = {
    "calculate_distance": {
        ...
        "function": {
            ...
            - Assessing proximity to other spacecraft or space debris
            - Measuring distances for scientific observations
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "object_coordinates": {
                        "type": "object",
                        "description": "The current coordinates of the celestial object in 3D space (x,y,z)",
                        "properties": {
                            "x": {"type": "number"},
                            "y": {"type": "number"},
                            "z": {"type": "number"},
    ...
    "calculate_gravity": {
        ...
        "function": {
            ...
            - Determining escape velocity for celestial objects
            - Calculating orbital parameters for spacecraft
...
def calculate_distance(
    *,
    current_coordinates: Dict[str, float],
...
def calculate_gravity(
    *, spacecraft_mass: float, object_mass: float, distance: float
) -> ToolResult[Dict[str, Any]]:
